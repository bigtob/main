...
variable "edition" {}
variable "maxsizegb" {}
variable "requestedserviceobjectivename" {}
...
resource "azurerm_sql_database" "sqldb" {
  ...
  create_mode                      = "Default"
  requested_service_objective_name = "${var.requestedserviceobjectivename}"
  max_size_bytes                   = "${var.maxsizegb*1024*1024*1024}"
  server_name                      = "${var.sqlserver}"
  tags {
    security  = "${var.sqlserveraudit},${var.sqlserversap},${var.sqlserveratp}"
  }
...
# these key-value pairs are passed into the ARM Template's `parameters` block
  parameters {
    ...
    "emailAddresses" = "andy.cudlip@sse.com,315224c3.ssecom.onmicrosoft.com@emea.teams.ms"
