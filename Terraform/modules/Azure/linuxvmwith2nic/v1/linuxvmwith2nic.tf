...
resource "azurerm_virtual_machine" "linuxvm" {
    ...
    network_interface_ids            = ["${azurerm_network_interface.networkinterfacedynamic.id}", "${azurerm_network_interface.networkinterfacedynamic2.id}"] 
    vm_size                          = "${var.vmsize}"
...
output "linuxvmnic" {
  ...
  value = ["${azurerm_network_interface.networkinterfacedynamic.*.id}"]  
}
output "linuxvmnic2" {
  #value = ["${azurerm_network_interface.networkinterfacestatic.*.id}", "${azurerm_network_interface.networkinterfacestatic2.*.id}"]  
  value = ["${azurerm_network_interface.networkinterfacedynamic2.*.id}"]  
}