...
module "getbuildsecrets" {
    ...
    secretname      = ["yourname","JobListUpload","${lookup(var.addaccount, var.domain)}","${lookup(var.addcomputer, var.domain)}","SQL-CMDB-Management"]
}
...
resource "azurerm_virtual_machine_extension" "ssesqlconfig" {
    ...
    settings = <<SETTINGS
    {
      "fileUris": [
        ...
        "https://yourstgacc.blob.core.windows.net/sep/setup.exe",
        "https://yourstgacc.blob.core.windows.net/windowspostbuild/accountmgmt.zip",
        "https://yourstgacc.blob.core.windows.net/windowspostbuild/bginfo.zip",
        "https://yourstgacc.blob.core.windows.net/windowspostbuild/bigfix.zip",
        "https://yourstgacc.blob.core.windows.net/windowspostbuild/ccs.zip",
        "https://yourstgacc.blob.core.windows.net/windowspostbuild/snow.zip",
        "https://yourstgacc.blob.core.windows.net/windowspostbuild/fixes.cmd"
      ]
    }
SETTINGS
